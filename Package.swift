...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.11.0/KubraWallet.zip",
            checksum: "49efa75c9b1b4f25615f01e25acff2294ed983186a6d5cd44ba6c2159cd36388"
        )
    ]
)
