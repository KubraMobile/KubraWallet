...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.11.1/KubraWallet.zip",
            checksum: "a08c02b96d67d129be46bacc3dbfda66323a4398d998d94ead1a4d4bf91e0ee7"
        )
    ]
)
