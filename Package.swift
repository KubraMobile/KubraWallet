...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.4.2/KubraWallet.zip",
            checksum: "fbdc2bbfc470feba7b67a9962402d328f512c764cddc575ce5d1dadefc5b4d0e"
        )
    ]
)
