...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.5.0/KubraWallet.zip",
            checksum: "c970c3a117b5f91f061ab98069fb8ff145cd36879fcd3e1e751d8e473f98b1d6"
        )
    ]
)
