...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/2.2.1/KubraWallet.zip",
            checksum: "c88d3963b2445215d8c7ca960ce3820fe277a192003d9af269993c5d04fe96bb"
        )
    ]
)
