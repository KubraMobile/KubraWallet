...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version//1.1.4/KubraWallet.zip",
            checksum: "3cd52dfb04cffe8679dbefc51a11d9220fc39f46bd329114262040b5f1413029"
        )
    ]
)
