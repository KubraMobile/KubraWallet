...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.4.0/KubraWallet.zip",
            checksum: "9e944503c7751b4e5897c347925b883220db7f6f99749adb75af92f8e95749a7"
        )
    ]
)
