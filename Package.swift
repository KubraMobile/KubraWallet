...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.3.2/KubraWallet.zip",
            checksum: "e9d3b1bcfec46947f3ca72842123bc083723f56ed1ed9b580bdf35053e8b445a"
        )
    ]
)
