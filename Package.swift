...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.12.0/KubraWallet.zip",
            checksum: "582f9eeaedb3ddad9e33efaf52393a1232d10d5e62bfa6e1cf68b220626f0e8e"
        )
    ]
)
