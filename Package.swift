...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/2.2.2/KubraWallet.zip",
            checksum: "88e1665bd609b5006f8c44081e56f0f8380f768f1fdce05fd976aad92b71e830"
        )
    ]
)
