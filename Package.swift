...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.3.4/KubraWallet.zip",
            checksum: "d0263bfa0fadf54270b87780c1201ca61abfe0436f39d604b338fe3ce2067b2b"
        )
    ]
)
