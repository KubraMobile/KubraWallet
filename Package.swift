...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KubraWallet",
            url: "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.6.3/KubraWallet.zip",
            checksum: "9b705ab1e62dc82e95146c22636ecf7bf59c0ef46376c3cfdd67ae9816723990"
        )
    ]
)
